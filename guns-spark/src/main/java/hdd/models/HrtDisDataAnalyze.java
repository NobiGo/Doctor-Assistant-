...
//        JavaRDD<String> rows = jctx.textFile("file:///C:/Users/dx/Desktop/HrtDisDetection/src/resources/full_data_cleaned.csv");
//
...
//        });
//
//        Dataset df = sqlCtx.createDataFrame(rowRdd, schema);
//        df.registerTempTable("heartDisData");
//
//        Dataset results = sqlCtx.sql("select min(age) from heartDisData");
//
//        JavaRDD jrdd = results.javaRDD().map(new Function<Row, String>() {
//
//            @Override
